        ...
        <div class="text-center">
            ...
            <div class="card">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <h4 class="mb-3 f-w-400">Pendaftaran Konsumen</h4>
                            <hr>
                            <div class="form-group mb-3">
                                <input type="text" class="form-control" id="namaKantin" placeholder="Nama Anda">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <a href="konsumen_login.php" class="btn btn-block btn-primary mb-4">Proses Daftar</a>
                            <hr>
