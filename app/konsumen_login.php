        ...
        <div class="auth-content text-center">
            ...
            <div class="card">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="card-body">
                            <h4 class="mb-3 f-w-400">Login Kantin</h4>
                            <hr>
                           
                            <div class="form-group mb-3">
                                <input type="email" class="form-control" id="email" placeholder="Email atau Telepon">
                            </div>
                            ...
                            <a href="konsumen_home.php" class="btn btn-block btn-primary mb-4">Proses Login</a>
                            <hr>
