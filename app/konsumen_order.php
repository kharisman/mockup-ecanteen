                            ...
                            <div class="tab-pane fade show active" id="order-menunggu" role="tabpanel" aria-labelledby="order-menunggu-tab">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $orderMenunggu = [
                                            ["12345", "Kantin A", "John Doe", "2023-09-21", "10:30 AM", "$50.00", "Menunggu Konfirmasi"],
                                            ["54321", "Kantin B", "Jane Smith", "2023-09-20", "2:45 PM", "$30.50", "Menunggu Pengiriman"],
                            ...
                            <div class="tab-pane fade" id="order-selesai" role="tabpanel" aria-labelledby="order-selesai-tab">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $orderSelesai = [
                                            ["67890", "Kantin C", "Alice Johnson", "2023-09-19", "9:15 AM", "$75.25", "Selesai"],
                                            ["98765", "Kantin D", "Bob Wilson", "2023-09-18", "3:30 PM", "$42.75", "Selesai"],
                                            // Tambahkan data lainnya sesuai kebutuhan
                                        ];
                            ...
                            <div class="tab-pane fade" id="order-batal" role="tabpanel" aria-labelledby="order-batal-tab">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $orderBatal = [
                                            ["54321", "Kantin B", "Jane Smith", "2023-09-17", "11:00 AM", "$20.00", "Dibatalkan"],
                                            ["12345", "Kantin A", "John Doe", "2023-09-16", "1:45 PM", "$10.75", "Dibatalkan"],
                                            // Tambahkan data lainnya sesuai kebutuhan
                                        ];
